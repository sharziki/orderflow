...
import { Search, ArrowLeft, Gift, CreditCard, Clock, CheckCircle, XCircle, AlertCircle, History, DollarSign, Calendar, TrendingDown, TrendingUp, RefreshCw } from 'lucide-react'
...
function formatCodeForApi(rawCode: string): string {
  ...
  // If it starts with GIFT, format as GIFT-XXXX-XXXX-XXXX
  ...
  // Otherwise just format with dashes every 4 chars
...
export default function CheckGiftCardBalance() {
  ...
  const handleCheckBalance = async () => {
    ...
    try {
      // Format the code properly with dashes as stored in database: GIFT-XXXX-XXXX-XXXX
      ...
      <div className="bg-[rgb(var(--color-primary))] text-white">
        <div className="max-w-4xl mx-auto px-4 py-12 sm:py-16">
          ...
          <p className="text-lg text-white/80 max-w-md">
            Enter your gift card code to view your current balance and transaction history.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        {giftCard && giftCard.valid && (
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100">
              ...
              <div className="p-6">
                <div className="flex items-center gap-3 mb-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-slate-500">Recent activity on this card</p>
                  </div>
                </div>
                
                <div className="space-y-3">
                  {giftCard.transactions.slice(0, 10).map((transaction: any, index: number) => (
                    <div
            ...
            {/* Info Box */}
            <div className="m-6 mt-0 p-4 bg-blue-50 border border-blue-100 rounded-xl">
              <div className="flex items-start gap-3">
                <AlertCircle className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
                <p className="text-sm text-blue-800">
                  <strong>Note:</strong> Gift cards can only be redeemed for in-store purchases. 
                  Present your gift card code to the cashier to use your balance.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-2xl shadow-xl shadow-slate-200/50 p-8 border border-slate-100">
            ...
            <div className="space-y-4">
              ...
              <div className="p-4 bg-slate-50 rounded-xl">
                ...
                <p className="text-sm text-slate-600">Gift cards can only be used for in-store purchases at Blu Fish House.</p>
              </div>
              <div className="p-4 bg-slate-50 rounded-xl">
                <p className="font-medium text-slate-900 mb-1">Do gift cards expire?</p>
                <p className="text-sm text-slate-600">No, Blu Fish House gift cards never expire.</p>
              </div>
            </div>
