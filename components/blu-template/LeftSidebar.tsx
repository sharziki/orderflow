    ...
    <aside className="w-80 bg-white border-r border-gray-200 h-full overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-10 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-900 placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-shadow"
            />
            {searchQuery && (
              <button
        ...
        <div>
          ...
          <div className={`grid gap-2 p-1 bg-gray-100 rounded-xl ${store.deliveryEnabled ? 'grid-cols-2' : 'grid-cols-1'}`}>
            <button
            ...
            <div className="mt-3 p-3 bg-green-50 border border-green-200 rounded-xl">
              <div className="flex items-start gap-2">
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-xs font-medium text-green-700 mb-1">Delivering to:</p>
                  <p className="text-xs text-green-600 line-clamp-2">{deliveryAddress}</p>
                </div>
                {onEditDeliveryAddress && (
                  <button
                    onClick={onEditDeliveryAddress}
                    className="flex-shrink-0 p-1 text-green-600 hover:text-green-700 transition-colors"
